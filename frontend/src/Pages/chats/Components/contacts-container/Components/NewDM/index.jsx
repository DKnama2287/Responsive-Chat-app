        ...
        <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
          ...
          <div>
            <Input
              ...
              className="rounded-lg p-6 bg-[#2c2b3e] border-none"
          ...
          {searchcontact.length <= 0 && (
            <div className="flex-1 md:flex flex-col justify-center mt-5 md:mt-0 items-center duration-1000 transition-all">
              ...
              />
              <div className="text-opacity-80 text-white flex flex-col gap-5 items-center mt-5 lg:text-2xl text-xl duration-300 transition-all text-center">
